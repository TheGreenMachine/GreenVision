...
def vision():
    ...
    while True:
        ...
        for contour in all_contours:
            ...
            if 50 < cv2.contourArea(contour) < 1750 and cv2.contourArea(contour) > 0.6 * biggest_contour_area:
        ...
        with open('vision_log.csv', mode='a+') as vl_file:
            ...
            vl_writer.writerow([[cv2.contourArea(contour) for contour in all_contours if cv2.contourArea(contour) > 25],
                                biggest_contour_area,
